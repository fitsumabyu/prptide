    ...
    <div className="relative bg-gradient-to-br from-gray-50 to-purple-50 py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative mb-16 py-3 px-6 overflow-hidden bg-gradient-to-r w-fit mx-auto">
          <h2 className="text-3xl font-bold text-purple-600 relative z-10">Advanced Research Applications</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Receptor Binding Analysis</h3>
              <p className="text-purple-50">
          ...
          <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Molecular Interactions</h3>
              <p className="text-purple-50">
        ...
        <div className="mt-12 text-center">
          <p className="text-red-600 font-medium bg-white/70 py-2 px-4 rounded-md inline-block">
