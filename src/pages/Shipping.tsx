        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-6">
              ...
              <li><strong>International Shipping (5-10 business days)</strong> - Available to most countries</li>
            </ul>
            
            <h3 className="text-xl font-semibold mt-6 mb-3">Shipping Costs</h3>
            <p className="text-gray-700 mb-6">
              Shipping costs are calculated based on the destination, weight, and selected shipping method. The exact shipping cost will be displayed during the checkout process before you complete your order.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-6">
              ...
              <li>International delivery times may vary based on customs clearance procedures</li>
              <li>Some countries have restrictions on importing certain peptides; please check your local regulations before ordering</li>
            </ul>
            ...
            <ol className="list-decimal pl-6 text-gray-700 mb-6">
              <li>Contact our customer service department at returns@peptidelabnexus.com or (800) 123-4567</li>
            ...
            <p className="text-gray-700 mb-6">
              Email: support@peptidelabnexus.com<br />
