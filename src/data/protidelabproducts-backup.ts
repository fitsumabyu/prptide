...
export const products: Product[] = [
  // Metabolisk Integritetsprotokoll Kits
  {
    ...
    swedishdescription: "Korrelerar till Semaglutide. Detta protokoll erbjuder ett komplett närings- och topiskt stödsystem för att motverka de primära bieffekterna av snabb viktminskning, med fokus på bevarande av muskelmassa, GI-funktion och hudintegritet.",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Semaglutide. Detta protokoll förstärker det grundläggande stödet med intensiv hudnäring och hårstöd, för att hantera de ökade estetiska bekymren vid högre dosregimer.",
    purity: "Premium Kvalitet",
    price: "2500 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Semaglutide. För intensiva, högdosprotokoll tillför detta kit omfattande stöd för leverfunktion och stressrespons, med erkännande av den ökade fysiologiska belastningen på kroppen.",
    purity: "Premium Kvalitet",
    price: "4500 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Semaglutide. Apex-protokollet är ett komplett, månadsbaserat konsumtionsbaserat hälsosystem som ger ett överväldigande överflöd av närings- och cosmeceutical stöd för maximala intensitetsregimer.",
    purity: "Premium Kvalitet",
    price: "8500 kr",
  ...
  // Kroppskomposition Stack Kits
  {
    ...
    swedishdescription: "Korrelerar till Tirzepatide. Detta grundläggande kit hanterar de viktigaste utmaningarna med dual-agonist terapi: stödjer bibehållandet av mager massa och säkerställer rätt näringsämnesupptag trots minskad aptit.",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Tirzepatide. Denna stack accelererar resultaten genom att tillföra dermalt stöd och viktiga proteinbyggstenar för att bekämpa estetiska bieffekter som hudsläpphet.",
    purity: "Forskningskvalitet",
    price: "1398 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Tirzepatide. Denna avancerade stack introducerar intensiva topiska behandlingar och leverstöd, vilket ger en mer holistisk approach för användare på förlängda eller högdosregimer.",
    purity: "Forskningskvalitet",
    price: "2796 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Tirzepatide. Apex-stacken är ett komplett konsumtionssystem för den seriösa bio-optimeraren, som ger multi-vägs stöd för cellulär energi, fysisk återhämtning och estetiskt underhåll.",
    purity: "Forskningskvalitet",
    price: "5592 kr",
  ...
  // Tri-Faktor Metabolisk Protokoll Kits
  {
    ...
    swedishdescription: "Korrelerar till Retatrutide. Detta grundläggande protokoll stödjer den avancerade tri-agonist mekanismen genom att tillhandahålla omfattande metabolisk optimering, som hanterar de komplexa fysiologiska kraven för tre-vägs hormonmodulering.",
    purity: "Premium Kvalitet",
    price: "1000 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Retatrutide. Detta förbättrade protokoll tillför omfattande lever- och metaboliskt stöd, med erkännande av den ökade fysiologiska komplexiteten hos tri-agonist terapi och dess krav på flera organsystem.",
    purity: "Premium Kvalitet",
    price: "1800 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Retatrutide. Detta avancerade protokoll introducerar omfattande stressanpassningsstöd och cellulärt skydd, som hanterar de intensiva fysiologiska kraven för maximal tri-agonist optimering.",
    purity: "Premium Kvalitet",
    price: "5000 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Retatrutide. Det ultimata tri-agonist stödsystemet, som tillhandahåller omfattande multi-vägs optimering med förlängd förrådstid och avancerade återhämtningsprotokoll för maximal intensitet metabolisk transformation.",
    purity: "Premium Kvalitet",
    price: "9000 kr",
  ...
  // Dermal Ommodellering Matrix Kits
  {
    ...
    swedishdescription: "Korrelerar till GHK-Cu. Detta kit tillhandahåller de viktiga synergistiska konsumtionsvarorna för att maximera hud- och hårföryngringseffekterna av kopparpeptidterapi genom att tillhandahålla viktiga strukturproteiner och förbättra topisk leverans.",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till GHK-Cu. Accelerator-kitet tillför en veckovis intensiv cosmeceutical behandling för att dramatiskt förbättra hudtextur och lyster, som arbetar i tandem med det dagliga serumet.",
    purity: "Kosmetisk Kvalitet",
    price: "1000 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till GHK-Cu. Denna avancerade matrix tillför engångs, högpotenta topiska behandlingar för en omedelbar ökning av hydrering och glans, som kompletterar det långsiktiga ommodelleringsprotokoll.",
    purity: "Kosmetisk Kvalitet",
    price: "1900 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till GHK-Cu. Apex-systemet tillhandahåller en intensiv, klinisk styrka kurs av konsumerbara cosmeceuticals, designade för användare som genomgår ett maximal intensitet systemisk föryngringsprotokoll.",
    purity: "Kosmetisk Kvalitet",
    price: "3600 kr",
  ...
  // Systemisk Torrhetsprotokoll Kits
  {
    ...
    swedishdescription: "Korrelerar till Isotretinoin ('Roaccutan'). Detta viktiga kit riktar sig direkt mot de vanligaste och allvarligaste bieffekterna av högdos retinoidterapi: extrem torrhet i hud, läppar och ögon, samtidigt som det ger grundläggande leverstöd.",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Isotretinoin ('Roaccutan'). Detta protokoll tillför närings- och topiskt stöd för led- och muskelhelse, som hanterar den vanliga bieffekten av artralgi (ledvärk) som upplevs under behandling.",
    purity: "Medicinsk Kvalitet",
    price: "1200 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Isotretinoin ('Roaccutan'). För högdosregimer uppgraderar detta protokoll till en mer potent form av leverstöd och tillför intensiva, engångs hydrerande behandlingar för svårt komprometterad hud.",
    purity: "Medicinsk Kvalitet",
    price: "2000 kr",
  ...
  },
  {
    ...
    swedishdescription: "Korrelerar till Isotretinoin ('Roaccutan'). Apex-protokollet erbjuder en komplett, multi-vägs konsumtionslösning, som tillför internt hydreringsstöd och en kraftfull topisk analgetika för maximal komfort under de mest intensiva kurserna.",
    purity: "Medicinsk Kvalitet",
    price: "3700 kr",
